const Cardsignup = ({hiddenCard}) => {
  return (
      <div className="w-dvw h-dvh absolute  flex justify-center items-center bg-zinc-700/50 z-10 backdrop-blur-sm">
        <div className="flex justify-center items-center h-100 w-150 bg-linear-to-b from-red-800 to-red-700 z-50 shadow-xl/30 rounded-xl">
          <div className="flex gap-10 p-10 h-100 items-center">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <span onClick={hiddenCard} className="text-white/70 font-bold cursor-pointer hover:text-zinc-100 transition-all">
                  Fechar
                </span>
              </div>
            </div>
